...
%the first for the printed version, the second for the pdf version
...
\usepackage[sorting=none]{biblatex} %use with \cite{} and \printbibliography[type=online,heading=subbibliography,title={Referencias web}]
	\renewbibmacro{in:}{\ifentrytype{article}{}{\printtext{\bibstring{in}\intitlepunct}}} %suppress "In: " in articles before Journal: https://tex.stackexchange.com/questions/10682/suppress-in-biblatex/10686#10686
