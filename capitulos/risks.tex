...
\begin{itemize}
	...
	\item \textbf{Risk analysis and planning}: All the risks are analized, setting their properties (probability, impact, indicator, etc). Also prevention and/or correction measures for each risk are planned in case they take place. Prevention are optional and deployed before the risk happens, while correction measures are mandatory and used after a risk triggers. There are three types of measures:
		\begin{itemize}
			...
			\item \textit{Transference}: Another entity takes care of the problem. In this project this almost never applies because there are no third-party involved to rely responsability on, except in very specific cases.
		\end{itemize}
...
The \textit{New} probability, impact, exposition or measures always are be different from their previous values, else they are omited.
%\begin{table}[H]
%	\begin{tabularx}{\textwidth}{|l|X|}
%		\hline
%		\rowcolor{gray!30}
%		Identifier & \textbf{R-} \\ \hline
%		Name &  \\ \hline
%		Date of the beginning of the problem & \\ \hline
%		Date of the solution of the problem & \\ \hline
%		Actions & \\ \hline
%		New probability & \\ \hline
%		New impact &   \\ \hline
%		New exposition &  \\ \hline
%	\end{tabularx}
%\end{table}
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{|l|X|}
		...
		New correction: Transference &
			Another person took charge of the problem until it dissapeared, freeing the student.
		\\ \hline
	\end{tabularx}
\end{table}
\begin{table}[H]
