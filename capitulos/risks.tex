...
\newcommand{\Rdieciocho}{Optional requirements increment the time need to complete the project}
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{|y|z|}
		...
		Identifier & \textbf{R-013} \\ \hline
		Name & \Rtrece \\ \hline
		Indicator & Finding a way to detect the occurrence takes 30\% more time than planned.\\ \hline % the code is done later!! first we THINK/DESIGN of a way to detect it
		Prevention: Mitigate
