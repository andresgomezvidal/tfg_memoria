...
The next table shows the list of identified risks of the project.

\newcommand{\Runo}{Optimistic planning, ``best case'', instead of a realistic ``expected case''}
...
\newcommand{\Rcinco}{Lack of feedback or support from the security consultants from Tarlogic}
\newcommand{\Rseis}{The learning curve of some technologies is larger than expected}
\newcommand{\Rsiete}{The uncertain parts of the project take more time than expected}
\newcommand{\Rocho}{Source material is not available}
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{|y|z|}
		...
		Description &
			...
			%If so, this impossibility could be hard to assure too, due to the complexity of nowadays technology.
		\\ \hline
		Negative effects &
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{|y|z|}
		...
		Negative effects &
			...
			%Even more if is about a chronic or serious sickness from a family member.
			\linej
			Vital requirements get less resources, making the project loss value.
		\\ \hline
		Probability & Medium\\ \hline
