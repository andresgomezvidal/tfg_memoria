...
\newcommand{\FComeback}{2019-03-04}
\newcommand{\FIncrementoUnoDosFinal}{2019-05-05}
...
\begin{figure}[H]
	...
	\begin{ganttchart}[
		...
		%\ganttbar[name=pause-background-top,bar/.style={fill=none, draw=none}]{}{\FIncrementoUnoDosInicial}{\FPause} 			% top node

		\ganttgroup{Project management}{\PStart}{\PClosing} \\
		\ganttbar[name=Beginning]{Beginning of the project}{\PStart}{\FBeginning} \\
		\ganttbar[name=Increment12Start]{Increment 1 and 2}{\SIncrementoUnoDosInicial}{\FIncrementoUnoDosInicial} \\ %pausa 3 meses
		\ganttbar[name=Pause, bar/.append style={fill=gray!80}]{Project on hold}{\FIncrementoUnoDosInicial}{\FPause} \\
		\ganttbar[name=Comeback]{Updating tools of the project}{\FPause}{\FComeback} \\
		\ganttbar[name=Increment12End]{Increment 1 and 2}{\FComeback}{\FIncrementoUnoDosFinal} \\
		...
		\ganttlink[link type=straight]{Beginning}{Increment12Start}
		\ganttlink[link type=straight]{Increment12Start}{Pause}
		\ganttlink[link type=straight]{Pause}{Comeback}
		\ganttlink[link type=straight]{Comeback}{Increment12End}
		...
		%\ganttbar[name=pause-background-bottom,bar/.style={fill=none, draw=none}]{}{\FIncrementoUnoDosInicial}{\FPause} 			% bottom node
		%\begin{scope}
...
\begin{figure}[H]
	...
	\begin{ganttchart}[
		...
		\ganttgroup[name=prel]{Check changes from last working setup}{\FPause}{2019-03-02} \\
		\ganttbar[name=tools]{Wazuh documentation and tools used in the project}{\FPause}{2019-03-01} \\
		\ganttbar[name=attacks]{Known and new attacks}{\FPause}{2019-03-02} \\
		\ganttmilestone[name=fmilestone]{Basic knowledge of the changes}{2019-03-02} \\

		\ganttbar[name=set]{Installing virtual machines and setting up tools}{2019-03-02}{2019-03-03} \\
		\ganttmilestone[name=milestone]{Ready to continue with the increments}{2019-03-03} \\
...
\begin{figure}[H]
	...
	\begin{ganttchart}[
		...
		title top shift=-.5,
		vgrid,
		]{\FComeback}{\FIncrementoUnoDosFinal}
		\newganttlinktypealias{straight}{f-s}
		\setganttlinklabel{straight}{}
	...
	\newcommand{\Daction}{2019-04-12}
		...
		\ganttgroup[name=pstudy]{Preliminary study and investigation}{\FComeback}{\Dstudy} \\
		\ganttbar[name=list]{Identify the attacks to detect}{\FComeback}{2019-03-04} \\
		\ganttbar[name=attack]{Detailed study of each attack and tools}{2019-03-05}{2019-03-20} \\
		...
		\ganttgroup[name=TF]{Testing and fixing}{2019-04-13}{\FIncrementoUnoDosFinal} \\
		\ganttbar[name=test]{Testing}{2019-04-13}{\FIncrementoUnoDosFinal} \\
		\ganttbar[name=fix]{Fixing}{2019-04-13}{\FIncrementoUnoDosFinal} \\

		\ganttmilestone[name=milestone]{Certain attacks can be detected now}{\FIncrementoUnoDosFinal} \\
