...
\begin{figure}[H]
	...
	\end{ganttchart}
	\end{center}
	\caption{Planning of the beginning of the project}
\end{figure}
...
\begin{figure}[H]
	...
	\end{ganttchart}
	\caption{Planning of the increment 1: \textit{\IncrementoUno}}
\end{figure}
...
\begin{figure}[H]
	...
	\end{ganttchart}
	\end{center}
	\caption{Planning of the increment 2: \textit{\IncrementoDos}}
\end{figure}
...
\begin{figure}[H]
	...
	\end{ganttchart}
	\end{center}
	\caption{Planning of the increment 3: \textit{\IncrementoTres}}
\end{figure}
...
\begin{figure}[H]
	...
	\end{ganttchart}
	\end{center}
	\caption{Planning of the increment 4: \textit{\IncrementoCuatro}}
\end{figure}
...
\begin{figure}[H]
	...
	\end{ganttchart}
	\end{center}
	\caption{Planning of the increment 5: \textit{\IncrementoCinco}}
\end{figure}
...
\begin{figure}[H]
	...
	\end{ganttchart}
	\end{center}
	\caption{Planning of the increment 6: \textit{\IncrementoSeis}}
\end{figure}
...
\begin{figure}[H]
	...
	\end{ganttchart}
	\end{center}
	\caption{Planning of the increment 7: \textit{\IncrementoSiete}}
\end{figure}
...
%Risk supervision is the process of tracking every risk and applying measures if they come to be.
...
%Due to reasons stated later\ref{increment_explanation} these increments that were planned to be implemented individually were actually done together.
...
\newcommand{\FIncrementoTres}{2019-07-18}
\newcommand{\SClosing}{2019-07-19}
\newcommand{\PClosing}{2019-07-23}
...
\begin{figure}[H]
	...
	\begin{ganttchart}[
		...
		\ganttbar[name=Comeback]{Updating tools}{\SComeback}{\FComeback} \\
...
\begin{figure}[H]
	...
	\end{ganttchart}
	\end{center}
	\caption{Planning of updating the tools of the project}
\end{figure}
...
\linej
The tasks initially planned for increment 2 were so small and integrated into already existing tasks for increment 1 that it made no sense to add them to this Gantt.
\newpage
\linej
\linej
\begin{sidewaysfigure}
	...
	\end{ganttchart}
	\caption{Planning of the increments 1 and 2}
\end{sidewaysfigure}
...
\begin{figure}[H]
	...
	\begin{ganttchart}[
		...
		\newcommand{\Dstudy}{2019-07-06}
		\newcommand{\STesting}{2019-07-07}

		\ganttgroup[name=pstudy]{Preliminary research and codification}{\SIncrementoTres}{\Dstudy} \\
		\ganttbar[name=list]{Study of ransomware}{\SIncrementoTres}{2019-06-23} \\
		\ganttbar[name=attack]{Codification of the basic file encryption example}{2019-06-24}{2019-06-24} \\
		\ganttbar[name=detection]{Exploration and codification of detection options}{2019-06-25}{\Dstudy} \\

		\ganttgroup[name=TF]{Testing and fixing}{\STesting}{\FIncrementoTres} \\
		\ganttbar[name=TD]{Testing and fixing the detection mechanisms}{\STesting}{2019-07-16} \\
		\ganttbar[name=RR]{Testing with real ransomware}{2019-07-17}{\FIncrementoTres} \\

		\ganttmilestone[name=milestone]{Detection/action against certain ransomware patterns}{\FIncrementoTres} \\

		\ganttlink{list}{attack}
		\ganttlink{attack}{detection}
		\ganttlink{pstudy}{TF}
		\ganttlink{TD}{RR}
		\ganttlink{TF}{milestone}
...
%\newcommand{\PClosing}{2019-07-23}
		...
		\ganttgroup[name=documentation]{Finishing the documentation of the project}{\SClosing}{\PClosing} \\
		\ganttbar[name=fixes]{Cost management and detail fixing}{\SClosing}{2019-07-19} \\
		\ganttbar[name=revision]{Review of the memory by the tutors}{2019-07-20}{\PClosing} \\
		\ganttmilestone[name=milestone]{The documentation of the project is finished}{\PClosing} \\


		\ganttlink{fixes}{revision}
		\ganttlink{revision}{milestone}

	\end{ganttchart}
	\end{center}
	\caption{Planning of the closing of the project}
\end{figure}
