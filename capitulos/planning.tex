...
\begin{figure}[h!bt]
	...
	\begin{ganttchart}[
		...
		\newganttlinktypealias{straight}{f-s}
		\setganttlinklabel{straight}{}
		\gantttitlelist{1,...,\Ddos}{1} \\
		\gantttitle{Days}{\Ddos} \\


		\ganttgroup{Study and investigation}{1}{5} \\
		\ganttbar[name=Wazuh,bar/.append style={fill=\Cnormal}]{Wazuh}{1}{3} \\
		\ganttbar[name=Pentesting,bar/.append style={fill=\Cnormal}]{Pentesting tools}{4}{5} \\

		\ganttgroup{Setting up the work environment}{6}{7} \\
		...
		\ganttmilestone[name=milestone]{Ready to start the first increment}{7} \\

		\ganttlink{Wazuh}{settingW}
