...
After the detection of a ransomware attack by any of the methods previously shown it is essential to stop or reduce the impact of the attack as soon as possible.
...
Therefore it is not a better option than using local antimalware software.
