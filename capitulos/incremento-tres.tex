...
%TODO \ref{} todas las formas de deteccion
%TODO false postives
	%usar 2 decoys (mim freq=2)
	%alternativamente solo 1 decoy con active response y file integrity monitoring
%TODO script para restaurar decoys?
	%para todas esas carpetas se puede copiar un archivo o un archivo de cada extensión aleatoriamente
