...
%TODO
\subsubsection{Reducing false positives with TODO}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Identifying generated files as encrypted. This still has a chance of being a legitimate process.
			%TODO problem extracting the folder from the logs that give the filename but not the folder and from syscheck (does not have fields at all)
				%just have a set of rules for each folder
...
%TODO detection
%TODO detection with enc or other measures to cover the command
%TODO AppLocker
...
\begin{itemize}
	...
	\item Use a remote script and on the server a set of scripts, real-time monitoring and the storage file. This is too complex and expensive in resources to consider it seriously.
\end{itemize}
%%Next is the complex solution keeping the file in the server
