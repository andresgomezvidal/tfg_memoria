...
%\linej
%\linej
%Having a working setup of Wazuh and Sysmon just requires to install Sysmon in the Windows computers and enable receiving its events in the configuration file for Wazuh (\textit{/var/ossec/etc/shared/default/agent.conf}):
...
The event ids generated by running the executable and the module are 4104, 4105 and 4106, of which the most useful seemed to be 4104.
%\begin{lstlisting}[style=xml]
%<agent_config os="Windows">
	%<localfile>
