...
\linej
\lstinputlisting[style=xml,caption=Wazuh rules for processing the output of the free space remote command,captionpos=b,label={lst:free_space_rules}]{src/space_volume/rules_free_space.xml}
\linej
