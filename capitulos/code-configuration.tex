...
\lstinputlisting[style=PS,caption=PowerShell script to get the free space in the backup volume and parse its output to JSON,captionpos=b,label={lst:free_space_ps1_simple}]{src/space_volume/free_space_simple.ps1}
\linej
...
%\lstinputlisting[style=xml,caption=Configuration in \textit{/var/ossec/etc/ossec.conf} for the free space detection,captionpos=b,label={lst:free_space_ossec_configuration}]{src/space_volume/ossec.conf}
%\linej
%\lstinputlisting[style=sh,caption=Bash script to compare the free space value with the previous one and change the storage file if it needs to,captionpos=b,label={lst:free_space_sh}]{src/space_volume/free_space.sh}
%\linej
%\lstinputlisting[style=sh,caption=Bash script to check the status and change the storage file if it needs to,captionpos=b,label={lst:free_space_modified_sh}]{src/space_volume/free_space_modified.sh}
%\linej
