...
\input{capitulos/project-management-introducion}
...
%no tiene sentido para un trabajo de investigación como este, en su lugar se explica lo básico de infraestructura y luego directamente la investigación
\cleardoublepage
\chapter{Laboratory}
\input{capitulos/architecture}
...
\input{capitulos/incremento-uno}

\cleardoublepage
\chapter{Increment 3}
\input{capitulos/incremento-tres}
...
\cleardoublepage
\include{capitulos/code-configuration}
